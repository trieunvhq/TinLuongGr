...
namespace CtyTinLuong
{
    public partial class KhoBTP_ChiTiet_DaNhapKho : Form
    {
        ...
        private void HienThi_Gridcontrol()
        {
            try
            {
                using (clsKhoBTP_tbChiTietNhapKho cls2 = new clsKhoBTP_tbChiTietNhapKho())
                {
                    ...
                    {
                        Double xxsoluongNHAP = CheckString.ConvertToDouble_My(dt3.Rows[i]["SoLuongNhap"].ToString());
                        Double xxsoluongtON = CheckString.ConvertToDouble_My(dt3.Rows[i]["SoLuongTon"].ToString());
                        Double xxdongia = CheckString.ConvertToDouble_My(dt3.Rows[i]["DonGia"].ToString());
                        ...
                        _ravi["ThanhTien"] = CheckString.ConvertToDecimal_My(xxsoluongNHAP * xxdongia);
                        _ravi["HienThi"] = "1";
