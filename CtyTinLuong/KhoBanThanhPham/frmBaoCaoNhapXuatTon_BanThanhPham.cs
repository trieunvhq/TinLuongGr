...
namespace CtyTinLuong
{
    public partial class frmBaoCaoNhapXuatTon_BanThanhPham : Form
    {
        ...
        public DataTable tinhtoanNXT_NhapXuat_TrongKy(DateTime tungayxx, DateTime denngayxx)
        {
            ...
            DataTable dt = cls1.SelectAll_HienThi_ALL_ChiTietNhapKho();
            ...
            DataTable dt2222 = cls2.SelectAll_HienThi_ALL_ChiTietXuatKho();
            ...
            if (dtDISTINCT.Rows.Count > 0)
            {
                for (int i = 0; i < dtDISTINCT.Rows.Count; i++)
                {
                    ...
                    {
                        DataTable dtnhapkho_MotVat_tu = TinhToan_NhapKho_ID_VTHH(ID_VTHHxxx, tungayxx, denngayxx);
                        ...
                        {
                            DataTable dtxuatkho_maotVatTu = TinhToan_XuatKho_ID_VTHH(ID_VTHHxxx, tungayxx, denngayxx);
        ...
        public DataTable tinhtoanNXT_Ton_DauKy(DateTime tungayxx, DateTime denngayxx)
        {
            ...
            dt.DefaultView.RowFilter = "boolTonDauKy = False and NgayChungTu<='" + tungayxx + "'and DaNhapKho=True";
            DataView dv = dt.DefaultView;
            DataTable dt22 = dv.ToTable();
            ...
            if (dtDISTINCT.Rows.Count > 0)
            {
                for (int i = 0; i < dtDISTINCT.Rows.Count; i++)
                {
                    ...
                    dtcnjsj.DefaultView.RowFilter = " boolTonDauKy = True and ID_VTHH=" + ID_VTHHxxx + "";
        ...
        public DataTable TinhToan_NhapKho_ID_VTHH(int iiiIDVTHH, DateTime tungayxxxx, DateTime denngayxxx)
        {
            ...
            DataTable dt = cls.SelectOne_W_ID_VTHH_W_NgayThang();
        ...
        public DataTable TinhToan_NhapKho_tonDauKy_ID_VTHH(int iiiIDVTHH, DateTime denngayxxx)
        {
            ...
            cls.iID_VTHH = iiiIDVTHH;
            DataTable dt = cls.SelectOne_W_ID_VTHH_W_NgayThang();
            dt.DefaultView.RowFilter = "boolTonDauKy = False and NgayChungTu<'" + denngayxxx + "'and DaNhapKho=True";
            DataView dv = dt.DefaultView;
        ...
        private void HienThi()
        {
            if (dteTuNgay.EditValue != null & dteDenNgay.EditValue != null)
            {
                ...
                DataTable dttrongky = tinhtoanNXT_NhapXuat_TrongKy(tungay, denngay);
