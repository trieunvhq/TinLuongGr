...
{
    public partial class DaiLy_ChiTietChoXuatKho_Moi : Form
    {
        ...
        private string soChungTu_KhoDaiLy()
        {
            string sochungtu;
        ...
        private void HienThi_Sua_XuatKho( int xxID_Xuatkho_DL)
        {
            clsDaiLy_tbXuatKho_Temp cls1 = new clsDaiLy_tbXuatKho_Temp();
            cls1.iID_XuatKhoDaiLy = xxID_Xuatkho_DL;
            DataTable dt = cls1.SelectOne();
            
            gridNguoiLap.EditValue = cls1.iID_NguoiNhap.Value;
            txtSoChungTu.Text = soChungTu_KhoDaiLy();
            ...
            DataTable dt2 = cls2.SA_W_ID_XuatKhoDaiLy(xxID_Xuatkho_DL);
            gridControl1.DataSource = dt2;


            clsDaiLy_tbChiTietXuatKho_Temp cls = new clsDaiLy_tbChiTietXuatKho_Temp();
            DataTable dtxx = cls.SA_W_ID_XuatKhoDaiLy(xxID_Xuatkho_DL);
        ...
        private void Luu_ChiTietNhapKho_BanThanhPham(int iiIDINhapKho)
        {
            ...
            for (int i = 0; i < mdtKhauTru.Rows.Count; i++)
            {
                if (mdtKhauTru.Rows[i]["NhapKho_TP_1_BTP_2_NPL_3"].ToString() == "Kho BTP")
                {
                    ...
                    {
                        cls.fSoLuongNhap = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["SoLuong"].ToString());
                        cls.fSoLuongTon = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["SoLuong"].ToString());
                    }
                    else
                    {
                        cls.fSoLuongNhap = 0;
                    ...
                    if (mdtKhauTru.Rows[i]["DonGia"].ToString() != "")
                        cls.fDonGia = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["DonGia"].ToString());
                    else cls.fDonGia = 0;
                    cls.bTonTai = true;
                    cls.bNgungTheoDoi = false;
                ...
                for (int i = 0; i < dttttt2.Rows.Count; i++)
                {
                    ...
                    try
                    {
                        if (bdaxuatkho == true)
                        {
                            ...
                            {
                                double soluongxuat = CheckString.ConvertToDouble_My(dttttt2.Rows[i]["SoLuong"].ToString());
                                Double douSoLuongTonCu;
                                douSoLuongTonCu = CheckString.ConvertToDouble_My(dt2xxx.Rows[0]["SoLuongTon"].ToString());
