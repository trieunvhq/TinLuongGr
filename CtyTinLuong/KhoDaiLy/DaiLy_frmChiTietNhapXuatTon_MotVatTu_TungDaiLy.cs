...
{
    public partial class DaiLy_frmChiTietNhapXuatTon_MotVatTu_TungDaiLy : Form
    {
        ...
        private void HienThi()
        {
            ...
            DateTime dteDenNgayxx = UCDaiLy_NhapXuatTon_theoDaiLy.mdadenngay;
            DateTime dteTuNgayxxx = UCDaiLy_NhapXuatTon_theoDaiLy.mdatungay;
            int ID_DaiLyxx= UCDaiLy_NhapXuatTon_theoDaiLy.miID_DaiLy;
            ...
            _ravi_Khong["Ton"] = UCDaiLy_NhapXuatTon_theoDaiLy.msoluongTonDauKy;
            dt2xxxx.Rows.Add(_ravi_Khong);
            double soluongton = 0, Tong_SoLuongNhap = 0, Tong_SoluongXuat = 0;
            soluongton = UCDaiLy_NhapXuatTon_theoDaiLy.msoluongTonDauKy;
            for (int i = 0; i <= songay; i++)
            {

                clsDaiLy_tbChiTietNhapKho cls1 = new clsDaiLy_tbChiTietNhapKho();
                cls1.iID_VTHH = UCDaiLy_NhapXuatTon_theoDaiLy.miiID_VTHH;
                DataTable dt1 = cls1.Select_One_NXT_TinhToan_newwwwww();
                dt1.DefaultView.RowFilter = " NgayChungTu ='" + ngaydautien + "'and DaNhapKho=True and ID_DaiLy="+ ID_DaiLyxx + "";
                ...
                if (dt11new.Rows.Count > 0) // có nhập
                {
                    ...
                    cls2.iID_VTHH = UCDaiLy_NhapXuatTon_theoDaiLy.miiID_VTHH;
                    DataTable dt2 = cls2.SelectAll_W_ID_VTHH_TinhToan_TenDaiLy_NXT();
                    dt2.DefaultView.RowFilter = " NgayChungTu ='" + ngaydautien + "'and DaXuatKho=True and ID_DaiLy=" + ID_DaiLyxx + "";
        ...
        public DaiLy_frmChiTietNhapXuatTon_MotVatTu_TungDaiLy()
        {
            InitializeComponent();
        }
        ...
        {
            miID_VTHH = UCDaiLy_NhapXuatTon_theoDaiLy.miiID_VTHH;
            ...
            mdatungay = UCDaiLy_NhapXuatTon_theoDaiLy.mdatungay;
            mdadenngay = UCDaiLy_NhapXuatTon_theoDaiLy.mdadenngay;
            msNguoiLap_Prtint = "";
        ...
        private void DaiLy_frmChiTietNhapXuatTon_MotVatTu_TungDaiLy_Load(object sender, EventArgs e)
        {
            DateTime teDenNgay = UCDaiLy_NhapXuatTon_theoDaiLy.mdadenngay;
            DateTime teTuNgay = UCDaiLy_NhapXuatTon_theoDaiLy.mdatungay;
            dteTuNgay.EditValue = teTuNgay;
            dteDenNgay.EditValue = teDenNgay;

            clsTbVatTuHangHoa cls = new clsTbVatTuHangHoa();
            cls.iID_VTHH = UCDaiLy_NhapXuatTon_theoDaiLy.miiID_VTHH;
