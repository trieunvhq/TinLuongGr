...
{
    public partial class UCDaiLy_BaoCao_NhapXuatTon : UserControl
    {
        ...
        public UCDaiLy_BaoCao_NhapXuatTon()
        {
            InitializeComponent();
        }
        ...
        private void bandedGridView1_DoubleClick(object sender, EventArgs e)
        {
            if (bandedGridView1.GetFocusedRowCellValue(clID_VTHH).ToString() != "")
            {
                if (dteTuNgay.EditValue != null & dteNgay.EditValue != null)
                {
                    ...
                    DaiLy_frmChiTietNhapXuatTon_MotVatTu ff2 = new DaiLy_frmChiTietNhapXuatTon_MotVatTu();
                    ff2.Show();
                }
        ...
        private void UCDaiLy_BaoCao_NhapXuatTon_Load(object sender, EventArgs e)
        {
        ...
        {
            UCDaiLy_BaoCao_NhapXuatTon_Load(sender, e);
