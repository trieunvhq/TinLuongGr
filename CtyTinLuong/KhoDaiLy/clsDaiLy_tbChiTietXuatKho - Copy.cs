...
namespace CtyTinLuong
{
	...
	public partial class clsDaiLy_tbChiTietXuatKho : clsDBInteractionBase
	{
        public DataTable SA_TonKho_W_ID_VTHH(int xxID_VTHH, DateTime ngay_batdau)
        {
            ...
            scmCmdToExecute.CommandText = "dbo.[pr_DaiLy_tbChiTietXuatKho_SA_TonKho_W_ID_VTHH]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_DaiLy_tbChiTietXuatKho_SA_TonKho_W_ID_VTHH");
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("pr_DaiLy_tbChiTietXuatKho_SA_TonKho_W_ID_VTHH", ex);
            }
            finally
            {
                //Close connection.
