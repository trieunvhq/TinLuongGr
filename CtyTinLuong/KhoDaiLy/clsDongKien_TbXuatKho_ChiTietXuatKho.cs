...
namespace CtyTinLuong
{
	...
	/// </summary>
	public class clsDongKien_TbXuatKho_ChiTietXuatKho : clsDBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		m_bTonTai, m_bNgungTheoDoi, m_bDaXuatKho;
			private SqlDouble		m_fThanhTien, m_fDonGia, m_fSoLuongXuat;
			private SqlInt32		m_iID_ChiTietXuatKho, m_iID_XuatKho_DongKien, m_iID_VTHH;
		...
		public override bool Insert()
		{
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_DongKien_TbXuatKho_ChiTietXuatKho_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
		...
		public override bool Update()
		{
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_DongKien_TbXuatKho_ChiTietXuatKho_Update' reported the ErrorCode: " + m_iErrorCode);
				}
		...
		public override bool Delete()
		{
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_DongKien_TbXuatKho_ChiTietXuatKho_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
		...
		public override DataTable SelectOne()
		{
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_DongKien_TbXuatKho_ChiTietXuatKho_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
		...
		public override DataTable SelectAll()
		{
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_DongKien_TbXuatKho_ChiTietXuatKho_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
