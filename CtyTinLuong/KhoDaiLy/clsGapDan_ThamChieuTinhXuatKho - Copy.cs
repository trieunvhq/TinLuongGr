...
namespace CtyTinLuong
{
	...
	{
        public DataTable SA_ID_XuatKho_2(int xxiID_XuatKho_)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ThamChieuTinhXuatKho_SA_ID_XuatKho_2]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_GapDan_ThamChieuTinhXuatKho_SA_ID_XuatKho_2");
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("pr_GapDan_ThamChieuTinhXuatKho_SA_ID_XuatKho_2", ex);
            }
            finally
            {
                //Close connection.
