...
{
    public partial class frmChiTietTamUng_DaiLy : Form
    {
        ...
        private void Luu__TbThuChi()
        {
            ...
            else
            {
                ...
                clsxxx1.sDoiTuong = txtTenDaiLy.Text.ToString();
               ...
               // clsxxx1.bBitThuChiKhac = true;
                clsxxx1.iID_DoiTuong = Convert.ToInt32(gridMaDaiLy.EditValue.ToString());
        ...
        private void Luu__VaobangLuong()
        {
            ...
            else
            {
                ...
                DataTable dt = cls.SelectOne__W_Thang_Nam_ID_DaiLy();
                if (dt.Rows.Count > 0)
                {
                    int ID_BangLuong = Convert.ToInt32(dt.Rows[0]["ID_BangLuong"].ToString());
        ...
        private bool LuuDuLieu_ChiLuu()
        {
            ...
            else
            {
                ...
                cls.iKhauTruLuongThang = Convert.ToInt32(txtThang.Text.ToString());
                ...
                if (UCDaiLy_TamUng.mbThemMoiTamUng == true)
                {
                    cls.Insert();
                }
                else
                ...
                UCDaiLy_TamUng.mbThemMoiTamUng = true;
                return true;
            }
        }
        ...
        public frmChiTietTamUng_DaiLy()
        {
            InitializeComponent();
        }

        private void frmChiTietTamUng_DaiLy_Load(object sender, EventArgs e)
        {
            Load_LockUp();
            if (UCDaiLy_TamUng.mbThemMoiTamUng == true)
            {
        ...
        private void txtThang_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dxxxx = cls.SelectAll_HienLuong_DaiLy();
                if (dxxxx.Rows.Count > 0)
                {
                    gridMaDaiLy.Properties.DataSource = dxxxx;
