...
namespace CtyTinLuong
{
    public partial class UCNPL_XuatKho_TheoLenhSanXuat_mayIN : UserControl
    {
        ...
        public void LoadData(int sotrang, bool isLoadLanDau, DateTime xxtungay, DateTime xxdenngay)
        {
            ...
            DataTable dt = cls.SelectAll_NgayThang_XuạtKho_NPL(_SoTrang,xxtungay, xxdenngay);          
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                if (gridView1.GetFocusedRowCellValue(clID_LenhSanXuat) != null)
                {

                    mID_iD_LenhSanXuat = Convert.ToInt16(gridView1.GetFocusedRowCellValue(clID_LenhSanXuat).ToString());
                    NPL_ChiTietLenhSanXuat ff = new NPL_ChiTietLenhSanXuat(this);
                    //_frmKNPL.Hide();
                    ff.Show();
                    //_frmKNPL.Show();
                }
