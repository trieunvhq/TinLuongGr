...
namespace CtyTinLuong
{
	...
	{
        //pr_DaiLy_tbNhapKho_Temp_Update_TrangThaiXuatNhap_KhoDaiLy
        ...
        public DataTable SelectAll_W_ID_NhapKhoDaiLy_Moi2(int id_dinhmuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_DaiLy_tbChiTietNhapKho_Temp_SelectAll_W_ID_NhapKhoDaiLy_Moi2]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_DaiLy_tbChiTietNhapKho_Temp_SelectAll_W_ID_NhapKhoDaiLy_Moi2");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
