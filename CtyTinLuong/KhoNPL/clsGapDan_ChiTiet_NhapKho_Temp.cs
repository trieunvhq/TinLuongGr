...
namespace CtyTinLuong
{
	public partial class clsGapDan_ChiTiet_NhapKho_Temp : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlInt32		m_iInt_TP_1_Chinh_2_Phu_3, m_iID_VTHH, m_iID_NhapKho, m_iID_ChiTietNhapKho;
			private SqlString		m_sGhiChu;
		#endregion


		public clsGapDan_ChiTiet_NhapKho_Temp()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_NhapKho_Temp_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@iint_TP_1_Chinh_2_Phu_3", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, m_iInt_TP_1_Chinh_2_Phu_3));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_NhapKho_Temp_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsGapDan_ChiTiet_NhapKho_Temp::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_NhapKho_Temp_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_NhapKho_Temp_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_NhapKho_Temp::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_NhapKho_Temp_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_NhapKho_Temp_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_NhapKho_Temp::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_NhapKho_Temp_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_ChiTiet_NhapKho_Temp");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_NhapKho_Temp_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_iInt_TP_1_Chinh_2_Phu_3 = (Int32)dtToReturn.Rows[0]["int_TP_1_Chinh_2_Phu_3"];
				}
				return dtToReturn;
			}
			catch(Exception ex)
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_NhapKho_Temp::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_NhapKho_Temp_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_ChiTiet_NhapKho_Temp");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_NhapKho_Temp_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_NhapKho_Temp::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		public SqlInt32 iInt_TP_1_Chinh_2_Phu_3
		{
			get
			{
				return m_iInt_TP_1_Chinh_2_Phu_3;
			}
			set
			{
				SqlInt32 iInt_TP_1_Chinh_2_Phu_3Tmp = (SqlInt32)value;
				if(iInt_TP_1_Chinh_2_Phu_3Tmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("iInt_TP_1_Chinh_2_Phu_3", "iInt_TP_1_Chinh_2_Phu_3 can't be NULL");
				}
				m_iInt_TP_1_Chinh_2_Phu_3 = value;
			}
		}
		#endregion
	}
