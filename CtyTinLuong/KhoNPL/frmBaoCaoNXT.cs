...
{
    public partial class frmBaoCaoNXT : Form
    {
        ...
        public DataTable NPL_tinhtoanNXT_NhapXuat_TrongKy(DateTime tungayxx, DateTime denngayxx)
        {
            ...
            DataTable dt = cls1.SelectAll_MaVT_TenVT_DVT();
            ...
            DataTable dt2222 = cls2.SelectAll_MaVT_TenVT_DVT();
        ...
        public DataTable NPL_TinhToan_NhapKho_ID_VTHH(int iiiIDVTHH, DateTime tungayxxxx, DateTime denngayxxx)
        {
            ...
            DataTable dt = cls.SelectOne_W_ID_VTHH_NXT_TinhToan_newwwwww();
        ...
        private void frmBaoCaoNXT_Load(object sender, EventArgs e)
        {
            ...
            NPL_HienThi();
            //gridControl2.DataSource = tinhtoanNXT_NhapXuat_TrongKy(dteTuNgay.DateTime, dteDenNgay.DateTime);
        }
