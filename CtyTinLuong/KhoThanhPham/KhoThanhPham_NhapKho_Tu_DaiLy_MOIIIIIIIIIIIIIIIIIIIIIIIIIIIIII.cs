...
namespace CtyTinLuong
{
    public partial class KhoThanhPham_NhapKho_Tu_DaiLy_MOIIIIIIIIIIIIIIIIIIIIIIIIIIIIII : Form
    {
        ...
        {
            string madaily = gridMaDaiLy.Text.ToString().Trim();
            string stendaily = txtTenDaiLy.Text;
        ...
        private string Load_soChungTu_DongKien()
        {
            string sochungtu = "";
        ...
        private void HienThi_Sua_XuatKho(int IDmiID_XuatKhoDaiLy)
        {
            ...
            if (cls1.bCheckNhapKho_ThanhPham_True_nhapKhoBTP_False == true)
                checkNhapKhoThanhPham.Checked = true;
            else checkNhapKhoDongKien.Checked = true;
            ...
            {               
                ...
                _ravi3["SoLuong"] = CheckString.ConvertToDouble_My(dtxx.Rows[i]["SoLuongXuat"].ToString());
                _ravi3["DonGia"] = CheckString.ConvertToDouble_My(dtxx.Rows[i]["DonGia"].ToString());
                _ravi3["HienThi"] = "1";
               
                _ravi3["ThanhTien"] = CheckString.ConvertToDouble_My(dtxx.Rows[i]["SoLuongXuat"].ToString())*CheckString.ConvertToDouble_My(dtxx.Rows[i]["DonGia"].ToString());               
        ...
        private void Load_LockUp()
        {
            ...
            DataTable dt2 = cls2.SelectAll_DIStintc_LayDanhSachDaiLy_XuatKho();
        ...
        private void Luu_ThamCHieuTinhXuatKho(int iiiiID_XuatKhoDaiLy)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < dtthamchieu.Rows.Count; i++)
                {
                    ...
                    cls3.fSoLuongThanhPhamQuyDoi = CheckString.ConvertToDouble_My(dtthamchieu.Rows[i]["SoLuongThanhPhamQuyDoi"].ToString());
                    cls3.fSoLuongNhap = CheckString.ConvertToDouble_My(dtthamchieu.Rows[i]["SoLuongNhap"].ToString());
                    cls3.bTonTai = true;
        ...
        private void Luu_NhapKhoThanhPham()
        {
            ...
            else
            {
                ...
                if (xxTongSoLuong.ToString() != "")
                    dexxTongSoLuong = CheckString.ConvertToDouble_My(xxTongSoLuong);
            ...
            else
            {
                ...
                if (mdtKhauTru.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < mdtKhauTru.Rows.Count; i++)
                    {
                        ...
                        cls5.fSoLuongNhap = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["SoLuong"].ToString());
                        cls5.fSoLuongTon = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["SoLuong"].ToString());
                        cls5.fDonGia = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["DonGia"].ToString());
                        cls5.bTonTai = true;
                        cls5.bNgungTheoDoi = false;
                        cls5.iID_DaiLy = Convert.ToInt32(gridMaDaiLy.EditValue.ToString());
                        cls5.bDaNhapKho = true;
        ...
        private void Luu_NhapKhoDongKien(int iiID_Xuatkho_Daily)
        {
            ...
            cls1.iID_XuatKho_ThamChieu = iiID_Xuatkho_Daily;
            cls1.daNgayChungTu = dteNgayChungTu.DateTime;
            ...
            cls1.iGapDan_1_DaiLy_2 = 2;
            DataTable dt2 = cls2.H_DongKien_SO_ID_XKGD(iiID_Xuatkho_Daily);
            if (dt2.Rows.Count > 0)
            {
                cls1.iID_NhapKhoDongKien = Convert.ToInt32(dt2.Rows[0]["ID_NhapKhoDongKien"].ToString());
                cls1.Update();
            }
            else cls1.Insert();
            int xxid = cls1.iID_NhapKhoDongKien.Value;
            Luu_ChiTiet_NhapKho_DongKien(xxid);

        }
        private void Luu_ChiTiet_NhapKho_DongKien(int iiiid_nhapkhodongkien)
        {
            string ahienthi = "1";
            DataTable adt1 = (DataTable)gridControl1.DataSource;
            adt1.DefaultView.RowFilter = "HienThi=" + ahienthi + "";
            DataView adv1 = adt1.DefaultView;
            DataTable dttttt2 = adv1.ToTable();

            clsDongKien_TbNhapKho_ChiTietNhapKho cls2 = new clsDongKien_TbNhapKho_ChiTietNhapKho();
            DataTable dt2_cu = new DataTable();
            dt2_cu = cls2.H_DongKienChiTiet_SA_ID_NKDK(iiiid_nhapkhodongkien);
            if (dt2_cu.Rows.Count > 0)
            {
                cls2.H_DongKienChiTiet_U_TonTai(iiiid_nhapkhodongkien, false);
            }
            for (int i = 0; i < dttttt2.Rows.Count; i++)
            {
            ...
            // xoa ton tai=false
            cls2 = new clsDongKien_TbNhapKho_ChiTietNhapKho();
            cls2.iID_NhapKho_DongKien = iiiid_nhapkhodongkien;
            DataTable dt2_moi11111 = cls2.H_DongKienChiTiet_SA_ID_NKDK(iiiid_nhapkhodongkien);
            dt2_moi11111.DefaultView.RowFilter = "TonTai = False";
            DataView dvdt2_moi = dt2_moi11111.DefaultView;
            DataTable dt2_moi = dvdt2_moi.ToTable();
            for (int i = 0; i < dt2_moi.Rows.Count; i++)
            {
                int iiID_ChiTietNhapKhoxxx = Convert.ToInt32(dt2_moi.Rows[i]["ID_ChiTietNhapKho"].ToString());
                cls2.iID_ChiTietNhapKho = iiID_ChiTietNhapKhoxxx;
                cls2.Delete();
            }
            cls2.Dispose();
        ...
        private void Luu_Va_GuiDuLieu()
        {
            ...
            else
            {
                try
                {
                    ...
                    {
                        Luu_NhapKhoDongKien(iiiiID_XuatKhoDaiLy);
                    }
                    // chi tiet nhập kho
        ...
        public KhoThanhPham_NhapKho_Tu_DaiLy_MOIIIIIIIIIIIIIIIIIIIIIIIIIIIIII(UCThanhPham_NhapKhoTuDaiLy_Newwwwwwwwwwwwwww ucNKTDL)
        {
            _ucNKTDL = ucNKTDL;
            InitializeComponent();
        }
        ...
        private void btPrint_Click(object sender, EventArgs e)
        {
            ...
            if (mdtPrint_Cu.Rows.Count > 0)
            {
                for (int i = 0; i < mdtPrint_Cu.Rows.Count; i++)
                {
                    ...
                    _ravi3["SoLuongNhap"] = CheckString.ConvertToDouble_My(mdtPrint_Cu.Rows[i]["SoLuongNhap"].ToString());
                    _ravi3["DonGia"] = CheckString.ConvertToDouble_My(mdtPrint_Cu.Rows[i]["DonGia"].ToString());
                    _ravi3["ThanhTien"] = CheckString.ConvertToDouble_My(mdtPrint_Cu.Rows[i]["ThanhTien"].ToString());
                ...
                if(mdtKhauTru.Rows.Count>0)
                {
                    for (int i = 0; i < mdtKhauTru.Rows.Count; i++)
                    {
                        ...
                        _ravi3["SoLuongNhap"] = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["SoLuong"].ToString());
                        _ravi3["DonGia"] = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["DonGia"].ToString());
                        _ravi3["ThanhTien"] = CheckString.ConvertToDouble_My(mdtKhauTru.Rows[i]["ThanhTien"].ToString());
                        mdtPrint.Rows.Add(_ravi3);
                    }
                }
        ...
        private void checkNhapKhoThanhPham_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void checkNhapKhoBTP_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                SendKeys.Send("{TAB}");
        ...
        private void checkNhapKhoThanhPham_CheckedChanged(object sender, EventArgs e)
        {
            if (checkNhapKhoThanhPham.Checked == true)
                checkNhapKhoDongKien.Checked = false;
        }

        private void checkNhapKhoBTP_CheckedChanged(object sender, EventArgs e)
        {
            if (checkNhapKhoDongKien.Checked == true)
        ...
        private void gridView4_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (e.Column == clSoChungTu1)
            {
                ...
                DataTable dt = cls.SelectOne();
                iiiID_ThanhPham = Convert.ToInt32(dt.Rows[0]["ID_VTHH_TPQuyDoi"].ToString());
            ...
            try
            {
                if (e.Column == clSoLuongNhap1)
                {
                    ...
                    if (gridView4.GetFocusedRowCellValue(clSoLuongThanhPhamQuyDoi1).ToString() == "")
                        ...
                        soluongthanhphamquydoi = CheckString.ConvertToDouble_My(gridView4.GetFocusedRowCellValue(clSoLuongThanhPhamQuyDoi1));
                    if (gridView4.GetFocusedRowCellValue(clSoLuongNhap1).ToString() == "")
                        soluongnhapthucte = 0;
                    else
                    ...
                    if (gridView4.GetFocusedRowCellValue(clDonGia1).ToString() == "")
                        ...
                        ffdongia = CheckString.ConvertToDouble_My(gridView4.GetFocusedRowCellValue(clDonGia1));
                    if (gridView4.GetFocusedRowCellValue(clSoLuongNhap1).ToString() == "")
                        fffsoluong = 0;
                    else
        ...
        private void btLayDuLieu_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                double tile = CheckString.ConvertToDouble_My(dt.Rows[i]["TiLe"].ToString());
                ...
                for (int j = 0; j < dtmnoi.Rows.Count; j++)
                {
                    ...
                    _ravi2["SoLuong"] = tile * CheckString.ConvertToDouble_My(dtmnoi.Rows[j]["SoLuongNhap"].ToString());
            ...
            try
            {
                ...
                if (e.Column == clSoLuong2)
                {
                    ...
                    if (gridView2.GetFocusedRowCellValue(clDonGia2).ToString() == "")
                        ...
                        ffdongia = CheckString.ConvertToDouble_My(gridView2.GetFocusedRowCellValue(clDonGia2));
                    if (gridView2.GetFocusedRowCellValue(clSoLuong2).ToString() == "")
                        fffsoluong = 0;                   
                        fffsoluong = CheckString.ConvertToDouble_My(gridView2.GetFocusedRowCellValue(clSoLuong2));
                    fffthanhtien = fffsoluong * ffdongia;
