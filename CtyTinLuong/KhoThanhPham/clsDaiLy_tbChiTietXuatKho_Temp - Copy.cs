...
namespace CtyTinLuong
{
	...
	{
        //pr_DaiLy_tbChiTietXuatKho_Temp_SelectAll_W_ID_NhapKhoDaiLy_Moi
        public void Delete_ALL_W_ID_XuatKhoDaiLy(int xxiID_XuatKhoDaiLy_)
        {

            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_DaiLy_tbChiTietXuatKho_Temp_Delete_ALL_W_ID_XuatKhoDaiLy]";
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("pr_DaiLy_tbChiTietXuatKho_Temp_Delete_ALL_W_ID_XuatKhoDaiLy::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        public void Update_ALL_TonTai(int xxiID_XuatKhoDaiLy_, bool xxTontai_)
        {
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_DaiLy_tbChiTietXuatKho_Temp_SA_W_ID_XuatKhoDaiLy]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_DaiLy_tbChiTietXuatKho_Temp_SA_W_ID_XuatKhoDaiLy");
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_DaiLy_tbChiTietXuatKho_Temp_SA_W_ID_XuatKhoDaiLy", ex);
            }
            finally
            {
                //Close connection.
        ...
        public DataTable SelectAll_W_ID_NhapKhoDaiLy_Moi(int xxiID_XuatKhoDaiLy_)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_DaiLy_tbChiTietXuatKho_Temp_SelectAll_W_ID_NhapKhoDaiLy_Moi]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_DaiLy_tbChiTietXuatKho_Temp_SelectAll_W_ID_NhapKhoDaiLy_Moi");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_DaiLy_tbChiTietXuatKho_Temp_SelectAll_W_ID_NhapKhoDaiLy_Moi", ex);
            }
            finally
            {
                //Close connection.
