...
namespace CtyTinLuong
{
	public class clsGapDan_ChiTiet_XuatKho_Temp : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlInt32		m_iNhapKho_TP_1_BTP_2_NPL_3, m_iID_XuatKho, m_iID_VTHH, m_iID_ChiTietXuatKho;
			private SqlString		m_sGhiChu;
		#endregion


		public clsGapDan_ChiTiet_XuatKho_Temp()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_XuatKho_Temp_Insert]";
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_XuatKho_Temp_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsGapDan_ChiTiet_XuatKho_Temp::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_XuatKho_Temp_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_XuatKho_Temp_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_XuatKho_Temp::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_XuatKho_Temp_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_XuatKho_Temp_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_XuatKho_Temp::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_XuatKho_Temp_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_ChiTiet_XuatKho_Temp");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_XuatKho_Temp_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_XuatKho_Temp::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ChiTiet_XuatKho_Temp_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_ChiTiet_XuatKho_Temp");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ChiTiet_XuatKho_Temp_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ChiTiet_XuatKho_Temp::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
