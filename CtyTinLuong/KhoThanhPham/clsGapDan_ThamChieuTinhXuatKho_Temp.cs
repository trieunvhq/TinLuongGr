...
namespace CtyTinLuong
{
	public partial class clsGapDan_ThamChieuTinhXuatKho_Temp : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlDouble		m_fSoLuongThanhPham_QuyDoi, m_fSoLuongXuat, m_fDonGia;
			private SqlInt32		m_iID_NhapKhoGapDan, m_iID_ThamChieu, m_iID_DinhMuc_ToGapDan, m_iID_XuatKhoGapDan, m_iID_VTHH;
		#endregion


		public clsGapDan_ThamChieuTinhXuatKho_Temp()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ThamChieuTinhXuatKho_Temp_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@iID_NhapKhoGapDan", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, m_iID_NhapKhoGapDan));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ThamChieuTinhXuatKho_Temp_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsGapDan_ThamChieuTinhXuatKho_Temp::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ThamChieuTinhXuatKho_Temp_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ThamChieuTinhXuatKho_Temp_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ThamChieuTinhXuatKho_Temp::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ThamChieuTinhXuatKho_Temp_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ThamChieuTinhXuatKho_Temp_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ThamChieuTinhXuatKho_Temp::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ThamChieuTinhXuatKho_Temp_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_ThamChieuTinhXuatKho_Temp");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ThamChieuTinhXuatKho_Temp_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_iID_NhapKhoGapDan = (Int32)dtToReturn.Rows[0]["ID_NhapKhoGapDan"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ThamChieuTinhXuatKho_Temp::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_ThamChieuTinhXuatKho_Temp_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_ThamChieuTinhXuatKho_Temp");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_ThamChieuTinhXuatKho_Temp_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_ThamChieuTinhXuatKho_Temp::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		public SqlInt32 iID_NhapKhoGapDan
		{
			get
			{
				return m_iID_NhapKhoGapDan;
			}
			set
			{
				SqlInt32 iID_NhapKhoGapDanTmp = (SqlInt32)value;
				if(iID_NhapKhoGapDanTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("iID_NhapKhoGapDan", "iID_NhapKhoGapDan can't be NULL");
				}
				m_iID_NhapKhoGapDan = value;
			}
		}
