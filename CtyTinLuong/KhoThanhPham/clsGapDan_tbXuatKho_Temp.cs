...
namespace CtyTinLuong
{
	public partial class clsGapDan_tbXuatKho_Temp : clsDBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		m_bDaXuatKho, m_bNgungTheoDoi, m_bTonTai, m_bTrangThaiNhapKhoBTP_ThanhPham, m_bGuiDuLieu, m_bCheckNhapKhoThanhPham;
			private SqlDateTime		m_daNgayChungTu;
			private SqlDouble		m_fSoLuongThanhPham_QuyDoi, m_fTongTienHang, m_fDonGia_ThanhPham_QuyDoi;
			private SqlInt32		m_iID_XuatKho, m_iID_NguoiNhap, m_iID_VTHH_ThanhPham_QuyDoi, m_iID_DinhMuc_ToGapDan;
			private SqlString		m_sDienGiai, m_sThamChieu, m_sSoChungTu, m_sNguoiGiaoHang;
		#endregion


		public clsGapDan_tbXuatKho_Temp()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_tbXuatKho_Temp_Insert]";
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_tbXuatKho_Temp_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsGapDan_tbXuatKho_Temp::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_tbXuatKho_Temp_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_tbXuatKho_Temp_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_tbXuatKho_Temp::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_tbXuatKho_Temp_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_tbXuatKho_Temp_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_tbXuatKho_Temp::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_tbXuatKho_Temp_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_tbXuatKho_Temp");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_tbXuatKho_Temp_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_tbXuatKho_Temp::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_GapDan_tbXuatKho_Temp_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("GapDan_tbXuatKho_Temp");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_GapDan_tbXuatKho_Temp_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsGapDan_tbXuatKho_Temp::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
