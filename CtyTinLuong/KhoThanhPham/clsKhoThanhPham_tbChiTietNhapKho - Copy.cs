...
namespace CtyTinLuong
{
	public partial class clsKhoThanhPham_tbChiTietNhapKho : clsDBInteractionBase
	{
        public DataTable SA_ID_Nhapkho(int xxid_nhapkho)
        {
            ...
            scmCmdToExecute.CommandText = "dbo.[H_ThanhPham__tbChitietNhapKho_SA_ID_Nhapkho]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("H_ThanhPham__tbChitietNhapKho_SA_ID_Nhapkho");
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("H_ThanhPham__tbChitietNhapKho_SA_ID_Nhapkho", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SD_MaVT_Load_lockUP]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_KhoThanhPham_tbChiTietNhapKho_SD_MaVT_Load_lockUP");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_KhoThanhPham_tbChiTietNhapKho_SD_MaVT_Load_lockUP", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SA_NhapTruocKy_ID_VTHH]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_KhoThanhPham_tbChiTietNhapKho_SA_NhapTruocKy_ID_VTHH");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_KhoThanhPham_tbChiTietNhapKho_SA_NhapTruocKy_ID_VTHH", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SA_NhapTrongKy_ID_VTHH]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_KhoThanhPham_tbChiTietNhapKho_SA_NhapTrongKy_ID_VTHH", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SA_distinct_NhapTruocKy]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_KhoThanhPham_tbChiTietNhapKho_SA_distinct_NhapTruocKy");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_KhoThanhPham_tbChiTietNhapKho_SA_distinct_NhapTruocKy", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SA_distinct_NhapTrongKy]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_KhoThanhPham_tbChiTietNhapKho_SA_distinct_NhapTrongKy");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_KhoThanhPham_tbChiTietNhapKho_SA_distinct_NhapTrongKy", ex);
            }
            finally
            {
                //Close connection.
