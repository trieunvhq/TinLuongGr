///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'KhoThanhPham_tbChiTietNhapKho'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'KhoThanhPham_tbChiTietNhapKho'.
	/// </summary>
    public partial class clsKhoThanhPham_tbChiTietNhapKho : clsDBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		m_bNgungTheoDoi, m_bTonTai, m_bBool_TonDauKy, m_bDaNhapKho;
			private SqlDouble		m_fDonGia, m_fSoLuongNhap, m_fSoLuongTon;
			private SqlInt32		m_iID_DaiLy, m_iID_NhapKho_ThanhPham, m_iID_VTHH, m_iID_ChiTietNhapKho_ThanhPham;
		...
		/// </summary>
		public clsKhoThanhPham_tbChiTietNhapKho()
		{
			// Nothing for now.
		}
		...
		///		 <LI>bNgungTheoDoi</LI>
		///		 <LI>sGhiChu</LI>
		///		 <LI>iID_DaiLy. May be SqlInt32.Null</LI>
		///		 <LI>bDaNhapKho</LI>
		///		 <LI>bBool_TonDauKy</LI>
		/// </UL>
		/// Properties set after a succesful call of this method: 
		/// <UL>
		///		 <LI>iID_ChiTietNhapKho_ThanhPham</LI>
		///		 <LI>iErrorCode</LI>
		/// </UL>
		/// </remarks>
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@iID_ChiTietNhapKho_ThanhPham", SqlDbType.Int, 4, ParameterDirection.Output, false, 10, 0, "", DataRowVersion.Proposed, m_iID_ChiTietNhapKho_ThanhPham));
				...
				m_iID_ChiTietNhapKho_ThanhPham = (SqlInt32)scmCmdToExecute.Parameters["@iID_ChiTietNhapKho_ThanhPham"].Value;
				m_iErrorCode = (SqlInt32)scmCmdToExecute.Parameters["@iErrorCode"].Value;

				if(m_iErrorCode != (int)LLBLError.AllOk)
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_KhoThanhPham_tbChiTietNhapKho_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsKhoThanhPham_tbChiTietNhapKho::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_KhoThanhPham_tbChiTietNhapKho_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsKhoThanhPham_tbChiTietNhapKho::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_KhoThanhPham_tbChiTietNhapKho_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsKhoThanhPham_tbChiTietNhapKho::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("KhoThanhPham_tbChiTietNhapKho");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_KhoThanhPham_tbChiTietNhapKho_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}

				if(dtToReturn.Rows.Count > 0)
				{
					m_iID_ChiTietNhapKho_ThanhPham = (Int32)dtToReturn.Rows[0]["ID_ChiTietNhapKho_ThanhPham"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsKhoThanhPham_tbChiTietNhapKho::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_KhoThanhPham_tbChiTietNhapKho_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("KhoThanhPham_tbChiTietNhapKho");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_KhoThanhPham_tbChiTietNhapKho_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsKhoThanhPham_tbChiTietNhapKho::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		public SqlInt32 iID_ChiTietNhapKho_ThanhPham
		{
			get
			{
				return m_iID_ChiTietNhapKho_ThanhPham;
			}
			set
			{
				SqlInt32 iID_ChiTietNhapKho_ThanhPhamTmp = (SqlInt32)value;
				if(iID_ChiTietNhapKho_ThanhPhamTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("iID_ChiTietNhapKho_ThanhPham", "iID_ChiTietNhapKho_ThanhPham can't be NULL");
				}
				m_iID_ChiTietNhapKho_ThanhPham = value;
			}
		}
