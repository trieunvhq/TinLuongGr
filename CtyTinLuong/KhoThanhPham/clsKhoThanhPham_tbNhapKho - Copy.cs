...
namespace CtyTinLuong
{
	...
	{
        //H_ThanhPham_NhapKho_SA_DongKien
        public DataTable SA_DongKien(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[H_ThanhPham_NhapKho_SA_DongKien]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("H_ThanhPham_NhapKho_SA_DongKien");
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("H_ThanhPham_NhapKho_SA_DongKien", ex);
            }
            finally
            {
                //Close connection.
        ...
        public DataTable SA_GapDan(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[H_ThanhPham_NhapKho_SA_GapDan]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("H_ThanhPham_NhapKho_SA_GapDan");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("H_ThanhPham_NhapKho_SA_GapDan", ex);
            }
            finally
            {
                //Close connection.
        ...
        public DataTable SA_Khac(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[H_ThanhPham_NhapKho_SA_Khac]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("H_ThanhPham_NhapKho_SA_Khac");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("H_ThanhPham_NhapKho_SA_Khac", ex);
            }
            finally
            {
                //Close connection.
