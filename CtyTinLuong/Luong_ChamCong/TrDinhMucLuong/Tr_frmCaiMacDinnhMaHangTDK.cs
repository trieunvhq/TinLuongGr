...
{
    public partial class Tr_frmCaiMacDinnhMaHangTDK : Form
    {
        ...
        private void LuuDuLieu()
        {
            ...
            else
            {
                ...
                // xoá trước
                cls1.Tr_CaiMacDinhMaHang_TDK_delete_thang_nam();
                string shienthi = "1";
                ...
                for (int i = 0; i < dv3.Rows.Count; i++)
                {
                    if (checkIDVTHH(Convert.ToInt32(dv3.Rows[i]["ID_VTHH"].ToString())))
                    {
                        ...
                        cls1.Tr_CaiMacDinhMaHang_TDK_Insert();
                    }
                }
        ...
        private void HienThi_Sua()
        {
            ...
            DataTable dt3 = cls.Tr_CaiMacDinhMaHang_TDK_SelectAll_thang_nam();
        ...
        public Tr_frmCaiMacDinnhMaHangTDK()
        {
            InitializeComponent();
        }

        private void Tr_frmCaiMacDinnhMaHangTDK_Load(object sender, EventArgs e)
        {
