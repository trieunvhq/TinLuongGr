...
// Generated by LLBLGen v1.3.5996.26197 Final on: Tuesday, October 19, 2021, 4:27:42 PM
...
namespace CtyTinLuong
{
	...
	public class clsTr_ChamCongPhienDich : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlInt32		m_iID_ChamConPhienDich, m_iID_CongNhan;
			private SqlString		m_sSoCont, m_sDienGiai, m_sKhachHang, m_sSoToKhai;
		#endregion
		...
		///		 <LI>sKhachHang. May be SqlString.Null</LI>
		...
		public bool Tr_ChamCongPhienDich_Insert()
		{
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@sKhachHang", SqlDbType.NVarChar, 150, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, m_sKhachHang));
		...
		public DataTable Tr_ChamCongPhienDich_SelectOne()
		{
			...
			try
			{
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_sKhachHang = dtToReturn.Rows[0]["KhachHang"] == System.DBNull.Value ? SqlString.Null : (string)dtToReturn.Rows[0]["KhachHang"];
		...
		/// <remarks>
		/// </remarks>
		public DataTable Tr_ChamCongPhienDich_SelectAll()
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
		...
		public SqlString sKhachHang
		{
			...
			set
			{
				SqlString sKhachHangTmp = (SqlString)value;
				if(sKhachHangTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("sKhachHang", "sKhachHang can't be NULL");
				}
				m_sKhachHang = value;
			}
		}
