...
// Generated by LLBLGen v1.3.5996.26197 Final on: Sunday, September 26, 2021, 12:26:20 PM
...
namespace CtyTinLuong
{
    ...
    public class clsTr_DinhMucLuongSL_TGD : clsDBInteractionBase
    {
        ...
        private SqlDecimal m_dcLoaiHang2, m_dcLoaiHang3, m_dcGiaCom, m_dcLoaiHang1, m_dcLoaiHang6, m_dcLoaiHang7, m_dcLoaiHang4, m_dcLoaiHang5, m_dcCucDot, m_dcGiaNghia2, m_dcGiaNghia, m_dcMacDinh, m_dcThoKimBat3, m_dcNCBat6Buoc, m_dcNCBat6;
        ...
        ///		 <LI>dcMacDinh. May be SqlDecimal.Null</LI>
        ...
        ///		 <LI>dcCucDot. May be SqlDecimal.Null</LI>
        ///		 <LI>dcGiaCom. May be SqlDecimal.Null</LI>
        ...
        public bool Tr_DinhMucLuongSL_TGD_Insert()
        {
            ...
            try
            {
                ...
                scmCmdToExecute.Parameters.Add(new SqlParameter("@dcMacDinh", SqlDbType.Decimal, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, m_dcMacDinh));
                ...
                scmCmdToExecute.Parameters.Add(new SqlParameter("@dcCucDot", SqlDbType.Decimal, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, m_dcCucDot));
                scmCmdToExecute.Parameters.Add(new SqlParameter("@dcGiaCom", SqlDbType.Decimal, 9, ParameterDirection.Input, false, 18, 0, "", DataRowVersion.Proposed, m_dcGiaCom));
        ...
        public DataTable Tr_DinhMucLuongSL_TGD_SelectOne()
        {
            ...
            try
            {
                ...
                if (dtToReturn.Rows.Count > 0)
                {
                    ...
                    m_dcMacDinh = dtToReturn.Rows[0]["MacDinh"] == System.DBNull.Value ? SqlDecimal.Null : (Decimal)dtToReturn.Rows[0]["MacDinh"];
                    ...
                    m_dcCucDot = dtToReturn.Rows[0]["CucDot"] == System.DBNull.Value ? SqlDecimal.Null : (Decimal)dtToReturn.Rows[0]["CucDot"];
                    m_dcGiaCom = dtToReturn.Rows[0]["GiaCom"] == System.DBNull.Value ? SqlDecimal.Null : (Decimal)dtToReturn.Rows[0]["GiaCom"];
        ...
        public SqlDecimal dcMacDinh
        {
            ...
            set
            {
                SqlDecimal dcMacDinhTmp = (SqlDecimal)value;
                if (dcMacDinhTmp.IsNull)
                {
                    throw new ArgumentOutOfRangeException("dcMacDinh", "dcMacDinh can't be NULL");
                }
                m_dcMacDinh = value;
            }
        }
        ...
        public SqlDecimal dcCucDot
        {
            ...
            set
            {
                SqlDecimal dcCucDotTmp = (SqlDecimal)value;
                if (dcCucDotTmp.IsNull)
                {
                    throw new ArgumentOutOfRangeException("dcCucDot", "dcCucDot can't be NULL");
                }
                m_dcCucDot = value;
            }
        }
        ...
        public SqlDecimal dcGiaCom
        {
            ...
            set
            {
                SqlDecimal dcGiaComTmp = (SqlDecimal)value;
                if (dcGiaComTmp.IsNull)
                {
                    throw new ArgumentOutOfRangeException("dcGiaCom", "dcGiaCom can't be NULL");
                }
                m_dcGiaCom = value;
            }
        }
