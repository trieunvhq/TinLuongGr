...
{
    public partial class Tr_PrintBangChamCong_TBX : DevExpress.XtraReports.UI.XtraReport
    {
        private int _thang;
        private int _nam;
        ...
        public Tr_PrintBangChamCong_TBX(int thang, int nam)
        {
            _thang = thang;
            _nam = nam;
            InitializeComponent();
...
setThu();
        ...
        public void setThu()
        {
            ...
            if (ngaycuathang_ == 28)
            {
                ...
                congFooter.WidthF = cong.WidthF = congHeader.WidthF = xrTableCell4.WidthF = xrTableCell2.WidthF = (float)84.29;
                //
                float tmp = 0;
                for (int i = 0; i < ngaycuathang_; ++i)
                {
                    Ds_NgayTitle[i].WidthF = (float)26.533;
                    Ds_Ngay_Header[i].WidthF = (float)26.533;
                    Ds_Ngay[i].WidthF = (float)26.533;
            ...
            else if (ngaycuathang_ == 29)
            {
                ...
                congFooter.WidthF = cong.WidthF = congHeader.WidthF = xrTableCell4.WidthF = xrTableCell2.WidthF;
