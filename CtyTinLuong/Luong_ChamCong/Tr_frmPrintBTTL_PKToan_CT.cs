...
{
    public partial class Tr_frmPrintBTTL_PKToan_CT : Form
    {
        ...
        public Tr_frmPrintBTTL_PKToan_CT(int thang, int nam, DataTable data)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        private void Tr_frmPrintBTTL_PKToan_CT_Load(object sender, EventArgs e)
        {
            Tr_PrintBTTL_PKToan_CT xtr111 = new Tr_PrintBTTL_PKToan_CT(_thang, _nam);
