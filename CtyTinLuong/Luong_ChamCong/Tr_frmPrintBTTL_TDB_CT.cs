...
{
    public partial class Tr_frmPrintBTTL_TDB_CT : Form
    {
        private int _thang;
        private int _nam;
        ...
        public Tr_frmPrintBTTL_TDB_CT(int thang, int nam, DataTable data, bool isTo1)
        {
            _isTo1 = isTo1;
            _data = data;
            _thang = thang;
        ...
        {
            Tr_PrintBTTL_TDB_CT xtr111 = new Tr_PrintBTTL_TDB_CT(_thang, _nam, _isTo1);
