...
{
    public partial class Tr_frmPrintBTTL_TDB_TQ_Old : Form
    {
        private int _thang;
        private int _nam;
        DataTable _data;
        public Tr_frmPrintBTTL_TDB_TQ_Old(int thang, int nam, DataTable data)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        private void Tr_frmPrintBTTL_TDB_TQ_Load(object sender, EventArgs e)
        {
            ...
            Tr_PrintBTTL_TDB_TQ_Old xtr111 = new Tr_PrintBTTL_TDB_TQ_Old(_thang, _nam);
