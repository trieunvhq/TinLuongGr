...
{
    public partial class Tr_frmPrintBTTL_TDK : Form
    {
        private int _thang;
        private int _nam;
        private DataTable _data;

        public Tr_frmPrintBTTL_TDK(int thang, int nam, DataTable data)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        private void Tr_frmPrintBTTL_TDK_Load(object sender, EventArgs e)
        {
