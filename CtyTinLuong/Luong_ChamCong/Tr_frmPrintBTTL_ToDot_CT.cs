...
{
    public partial class Tr_frmPrintBTTL_ToDot_CT : Form
    {
        private int _thang;
        private int _nam;
        private DataTable _data;

        public Tr_frmPrintBTTL_ToDot_CT(int thang, int nam, DataTable data)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        private void Tr_frmPrintBTTL_ToDot_Load(object sender, EventArgs e)
        {
            Tr_PrintBTTL_ToDot_CT xtr111 = new Tr_PrintBTTL_ToDot_CT(_thang, _nam);
