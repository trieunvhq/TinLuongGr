...
{
    public partial class Tr_frmPrintCT_Luong_SL : Form
    {
        private int _thang;
        private int _nam;
        public Tr_frmPrintCT_Luong_SL(int thang, int nam)
        {
            _thang = thang;
            _nam = nam;
            InitializeComponent();
        ...
        private void Tr_frmPrintCT_Luong_SL_Load(object sender, EventArgs e)
        {
            Tr_PrintCT_Luong_SL xtr111 = new Tr_PrintCT_Luong_SL(_thang, _nam);
