...
{
    public partial class Tr_frmPrintChamCongTrgCa : Form
    {
        ...
        public Tr_frmPrintChamCongTrgCa(int thang, int nam, DataTable data)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        {
            TrPrintChamCongTrgCa xtr111 = new TrPrintChamCongTrgCa(_thang, _nam);
