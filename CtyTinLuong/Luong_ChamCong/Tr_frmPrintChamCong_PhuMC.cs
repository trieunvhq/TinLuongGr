...
{
    public partial class Tr_frmPrintChamCong_PhuMC : Form
    {
        ...
        public Tr_frmPrintChamCong_PhuMC(int thang, int nam, DataTable data)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        private void Tr_frmPrintChamCong_PhuMC_Load(object sender, EventArgs e)
        {
            TrPrintChamCong_PhuMC xtr111 = new TrPrintChamCong_PhuMC(_thang, _nam);
