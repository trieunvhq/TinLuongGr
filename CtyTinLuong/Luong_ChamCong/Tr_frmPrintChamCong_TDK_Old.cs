...
{
    public partial class Tr_frmPrintChamCong_TDK_Old : Form
    {
        ...
        public Tr_frmPrintChamCong_TDK_Old(int thang, int nam, DataTable data, bool isTo1)
        {
            _data = data;
            _thang = thang;
            _nam = nam;
        ...
        private void Tr_frmPrintChamCong_TDK_Old_Load(object sender, EventArgs e)
        {
