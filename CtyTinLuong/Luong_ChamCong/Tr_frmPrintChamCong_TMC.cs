...
{
    public partial class Tr_frmPrintChamCong_TMC : Form
    {
        ...
        public Tr_frmPrintChamCong_TMC(int thang, int nam, int id_bophan)
        {
        ...
        private void Tr_frmPrintChamCong_TMC_Load(object sender, EventArgs e)
        {
