...
{
    public partial class Tr_frmPrintChamCong_ToDot : Form
    {
        ...
        public Tr_frmPrintChamCong_ToDot(int thang, int nam, int id_bophan)
        {
        ...
        private void Tr_frmPrintChamCong_ToDot_Load(object sender, EventArgs e)
        {
