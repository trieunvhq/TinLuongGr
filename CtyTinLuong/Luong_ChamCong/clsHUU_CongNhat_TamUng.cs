...
namespace CtyTinLuong
{
	public partial class clsHUU_CongNhat_TamUng : clsDBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlInt32		m_iID_TKCo, m_iID_NguoiLap, m_iID_TamUng, m_iKhauTruLuongThang, m_iID_NguoiTamUng, m_iID_TKNo, m_iKhauTruLuongThang_Nam;
			private SqlString		m_sSoChungTu, m_sDienGiai;
		#endregion


		public clsHUU_CongNhat_TamUng()
		{
			// Nothing for now.
		}
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_CongNhat_TamUng_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@iID_NguoiTamUng", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, m_iID_NguoiTamUng));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_CongNhat_TamUng_Insert' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsHUU_CongNhat_TamUng::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_CongNhat_TamUng_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_CongNhat_TamUng_Update' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_CongNhat_TamUng::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_CongNhat_TamUng_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_CongNhat_TamUng_Delete' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_CongNhat_TamUng::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_CongNhat_TamUng_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("HUU_CongNhat_TamUng");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_CongNhat_TamUng_SelectOne' reported the ErrorCode: " + m_iErrorCode);
				}
				...
				if(dtToReturn.Rows.Count > 0)
				{
					...
					m_iID_NguoiTamUng = (Int32)dtToReturn.Rows[0]["ID_NguoiTamUng"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_CongNhat_TamUng::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_HUU_CongNhat_TamUng_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("HUU_CongNhat_TamUng");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'pr_HUU_CongNhat_TamUng_SelectAll' reported the ErrorCode: " + m_iErrorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsHUU_CongNhat_TamUng::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		public SqlInt32 iID_NguoiTamUng
		{
			get
			{
				return m_iID_NguoiTamUng;
			}
			set
			{
				SqlInt32 iID_NguoiTamUngTmp = (SqlInt32)value;
				if(iID_NguoiTamUngTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("iID_NguoiTamUng", "iID_NguoiTamUng can't be NULL");
				}
				m_iID_NguoiTamUng = value;
			}
		}
