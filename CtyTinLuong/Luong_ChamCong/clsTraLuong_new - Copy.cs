...
namespace CtyTinLuong
{
	public partial class clsTraLuong_new : clsDBInteractionBase
	{
        public DataTable Dem_Dong_CongNhan(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            ...
            scmCmdToExecute.CommandText = "dbo.[pr_TraLuong_new_Dem_Dong_CongNhan]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_TraLuong_new_Dem_Dong_CongNhan");
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("pr_TraLuong_new_Dem_Dong_CongNhan", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_TraLuong_new_Dem_Dong_DaiLy]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_TraLuong_new_Dem_Dong_DaiLy");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_TraLuong_new_Dem_Dong_DaiLy", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_TraLuong_new_SA_W_NgayThang_DaiLy]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_TraLuong_new_SA_W_NgayThang_DaiLy");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_TraLuong_new_SA_W_NgayThang_DaiLy", ex);
            }
            finally
            {
                //Close connection.
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_TraLuong_new_SA_W_NgayThang_CongNhan]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_TraLuong_new_SA_W_NgayThang_CongNhan");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_TraLuong_new_SA_W_NgayThang_CongNhan", ex);
            }
            finally
            {
                //Close connection.
