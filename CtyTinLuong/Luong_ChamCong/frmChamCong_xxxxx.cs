...
{
    public partial class frmChamCong_xxxxx : UserControl
    { 
        ...
        public frmChamCong_xxxxx(int id_bophan, frmQuanLy_Luong_ChamCong frmQLLCC)
        {
            _frmQLLCC = frmQLLCC;
        ...
        private void frmChamCong_xxxxx_Load(object sender, EventArgs e)
        {
        }
