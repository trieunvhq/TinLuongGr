...
{
    public partial class Quy_NganHang_ChiTiet_CongNho_Newwwwww : Form
    {
        ...
        private void HienThi()
        {
            ...
            DateTime dteDenNgayxx = frmCongNho_NganHang.mdteDenNgay;
            DateTime dteTuNgayxxx = frmCongNho_NganHang.mdteTuNgay;
            ...
            _ravi_Khong["NoCuoiKy"] = frmCongNho_NganHang.mdbNoDauKy;
            _ravi_Khong["CoCuoiKy"] = frmCongNho_NganHang.mdbCoDauKy;

            dt2xxxx.Rows.Add(_ravi_Khong);
            double sotien_No = 0, sotien_Co = 0, Tong_Soluong_No_phatsinh = 0, Tong_Soluong_Co_phatsinh = 0;
            sotien_No = frmCongNho_NganHang.mdbNoDauKy;
            sotien_Co = frmCongNho_NganHang.mdbCoDauKy;
            for (int i = 0; i <= songay; i++)
            {

                clsNganHang_ChiTietBienDongTaiKhoanKeToan cls1 = new clsNganHang_ChiTietBienDongTaiKhoanKeToan();
             
                cls1.iID_TaiKhoanKeToanCon = frmCongNho_NganHang.miiiID_TaiKhoanKeToanCon;
        ...
        public Quy_NganHang_ChiTiet_CongNho_Newwwwww()
        {
            InitializeComponent();
        }

        private void Quy_NganHang_ChiTiet_CongNho_Newwwwww_Load(object sender, EventArgs e)
        {
            ...
            dteDenNgay.EditValue = frmCongNho_NganHang.mdteDenNgay;
            dteTuNgay.EditValue = frmCongNho_NganHang.mdteTuNgay;
            HienThi();
        }
