...
namespace CtyTinLuong
{
	...
	public partial class clsHUU_LenhSanXuat : clsDBInteractionBase
	{
        ...
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[r_HUU_LenhSanXuat_SA_t111]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("r_HUU_LenhSanXuat_SA_t111");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("r_HUU_LenhSanXuat_SA_t111", ex);
            }
            finally
            {
                //Close connection.
        ...
        public DataTable HUU_LenhSanXuat_SA_NhapKho_BTP_t11(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[HUU_LenhSanXuat_SA_NhapKho_BTP_t11]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("HUU_LenhSanXuat_SA_NhapKho_BTP_t11");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("HUU_LenhSanXuat_SA_NhapKho_BTP_t11", ex);
            }
            finally
            {
                //Close connection.
