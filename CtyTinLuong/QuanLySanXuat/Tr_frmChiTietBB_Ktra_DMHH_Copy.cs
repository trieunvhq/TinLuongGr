...
{
    public partial class Tr_frmChiTietBB_Ktra_DMHH_Copy : Form
    {
        bool mbThemMoi_DOT;
        ...
        public Tr_frmChiTietBB_Ktra_DMHH_Copy()
        {
            InitializeComponent();
        }

        private void Tr_frmChiTietBB_Ktra_DMHH_Copy_Load(object sender, EventArgs e)
        {
